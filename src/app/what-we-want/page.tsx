            ...
            <div className="mb-12">
              ...
              <div className="space-y-8">
                {[
                  ...
                  {
                    n: '৩', title: 'ফাস্ট-ট্র্যাক আদালত, ১৮০ দিনের মধ্যে রায়',
                  ...
                  {
                    n: '৪', title: 'সরকারি মানসিক স্বাস্থ্য পরিষেবা, সবার জন্য',
                  ...
                  {
                    n: '৫', title: 'অনলাইন শিশু শোষণ প্রতিরোধে বিশেষ টাস্কফোর্স',
              ...
              <div className="space-y-8">
                {[
                  ...
                  },
                  {
                    ...
                    body: 'ইভটিজিং, পশু নির্যাতন, বুলিং, দুর্বলদের হেয় করা এগুলো ছোট মনে হলেও এগুলো সতর্কতার লক্ষণ। যে বাচ্চা বিড়াল মারে সে বড় হয়ে কী করতে পারে, সেটা গবেষণা বলে। আশেপাশে কাউকে এরকম আচরণ করতে দেখলে সরাসরি রিপোর্ট করুন। নজর রাখা দায়িত্ব, নাক গলানো না।'
                  },
                  {
                  ...
                  {
                    n: 'ঙ', title: 'কমিউনিটি লিডারদের জবাবদিহিতা',
