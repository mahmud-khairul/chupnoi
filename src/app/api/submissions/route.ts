  ...
  try {
    ...
    const submission = await db.submission.create({
      data: {
        ...
        courtDocuments: body.courtDocuments ?? null,
        ...
        victimNameHidden: body.victimNameHidden ?? false,
        submitterAnonymous: body.submitterAnonymous ?? false,
